  ...
  return (
    <div className={className}>
      ...
      {!value && !uploading ? (
        ...
        >
          <div className="p-3 rounded-xl bg-white border border-slate-200 text-brand-700 shadow-sm">
        ...
        <div className="p-8 rounded-xl border-2 border-dashed border-brand-200 bg-brand-50/40 text-center">
          <Loader2 className="h-8 w-8 mx-auto text-brand-700 animate-spin mb-3" />
          <p className="text-sm font-semibold text-slate-800">Uploading…</p>
          <div className="mt-4 h-2 rounded-full bg-white border border-brand-100 overflow-hidden max-w-xs mx-auto">
            <div
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 px-1">
            <div className="min-w-0">
              <p className="text-sm font-medium text-slate-800 truncate">{value.fileName}</p>
            ...
            <button
              ...
              onClick={handleClear}
              disabled={disabled}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-red-600 hover:bg-red-50 border border-red-100 transition-colors disabled:opacity-50"
            >
